...
export const finnishUi: Record<string, string> = {
	...
	"Alert events": "Hälytystapahtumat",
	Appearance: "Ulkoasu",
	Font: "Fontti",
	"Font size": "Fonttikoko",
	"Bold text": "Lihavoitu teksti",
	"Text color": "Tekstin väri",
	"Outline width": "Reunaviivan leveys",
	"Outline color": "Reunaviivan väri",
	"Text shadow": "Tekstin varjo",
	"Transparent background": "Läpinäkyvä tausta",
	"Background color": "Taustaväri",
	"Picture or GIF": "Kuva tai GIF",
	"Replace picture or GIF": "Vaihda kuva tai GIF",
	"Upload picture or GIF": "Lataa kuva tai GIF",
	"PNG, JPEG, WebP or GIF, up to 10 MB. Animations up to 30 seconds and 300 frames.":
		"PNG, JPEG, WebP tai GIF, enintään 10 Mt. Animaatiot enintään 30 sekuntia ja 300 ruutua.",
	"Alert picture": "Hälytyskuva",
	"Picture could not be loaded": "Kuvaa ei voitu ladata",
	"Remove picture": "Poista kuva",
	"Picture layout": "Kuvan asettelu",
	"Picture above text": "Kuva tekstin yläpuolella",
	"Picture beside text": "Kuva tekstin vieressä",
	"Picture behind text": "Kuva tekstin takana",
	"Picture only": "Vain kuva",
	"Picture size (%)": "Kuvan koko (%)",
	"Picture spacing": "Kuvan välistys",
	"Alert duration (seconds)": "Hälytyksen kesto (sekuntia)",
	"Test alert plays your design in the draft preview. Save and apply to use it on stream.":
		"Testaa hälytys luonnoksen esikatselussa. Tallenna ja ota käyttöön näyttääksesi sen lähetyksessä.",
	"Sample event": "Testitapahtuma",
	"subscribed!": "tilasi!",
	"cheered 100 bits!": "lahjoitti 100 bittiä!",
	"followed!": "seurasi!",
