...
VISP is the authenticated relay and control plane in this workflow. This
third-party OBS path does not transcode the feed or aggregate network capacity. SRT retransmission
