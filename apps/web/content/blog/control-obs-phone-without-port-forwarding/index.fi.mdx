...
HTTPS-yhteyden VISPiin, joten reitittimeen ei tarvitse avata OBS:lle tulevaa
porttia.
...
![Puhelin lähettää todennetun komennon VISPiin, ja OBS-lisäosa vastaanottaa sen seuraavassa ulospäin suuntautuvassa HTTPS-kyselyssä](./phone-visp-obs-control-flow.svg)
...
katkaisee vanhojen lisäosa-asetusten yhteyden niiden seuraavalla kyselyllä.
...
päällekkäiset komennot, ja lisäosa saa yhdellä kyselyllä korkeintaan yhden
odottavan ohjeen. VISP kertoo komennon välityksestä ja OBS:n tilasta, mutta se
...
3. Yhdistetty OBS-lisäosa lähettää ulospäin HTTPS-ohjauskyselyn noin kahden
   sekunnin välein. Se raportoi lähetyksen tilan, kohtausnimet ja nykyisen
   kohtauksen.
4. VISP palauttaa vastauksessa korkeintaan yhden odottavan komennon.
5. Lisäosa suorittaa komennon OBS:ssä ja kuittaa komentoversion myöhemmässä
   kyselyssä.

Koska OBS aloittaa jokaisen ohjauspyynnön, lisäosa ei avaa internetiin
kuuntelevaa porttia eikä tarvitse reitittimen porttiohjausta. Tavallisen
komennon saapuminen OBS:ään kestää enintään noin kaksi sekuntia. Ratkaisu sopii
harkittuihin leikkauksiin ja lähetyksen ohjaamiseen, ei kuvaruudun tarkkaan
vaihtamiseen.

Konetunnus on yleistä VISP-istuntoa rajatumpi: se tukee lisäosan laite- ja Media
Source -työnkulkua sekä ohjauskyselyä, mutta ei anna pääsyä tilin tai
...
katkeaa, OBS sulkeutuu tai lisäosa lakkaa kyselemästä. **Offline** tarkoittaa,
...
OBS-lisäosan HTTPS-kyselyiden kautta. OBS koostaa edelleen valmiit kohtaukset ja
...
yhdistetty. Tarkista ulospäin toimiva HTTPS-yhteys ja se, ettei tietokone ole
...
Pidä OBS käynnissä ja yhteydessä seuraavaan kyselyyn asti. Nimeä kohtaukset
...
Varaa seuraavaan lisäosakyselyyn noin kaksi sekuntia äläkä lähetä nopeita
peräkkäisiä komentoja. Käytä paikan päällä olevaa tuottajaa tai paikallista
ohjausta, kun ajoituksen pitää olla tarkka.
...
ulospäin suuntautuvaa HTTPS-kyselyään eikä avaa OBS:lle tulevaa ohjausporttia.
